...
const routes: Routes = [
  ...
  {path:'editar-partido-futbol/:id/:torneo',component:EditarPartidoFutbolComponent},
  ...
  {path:'editar-partido-basquetbol/:id/:torneo',component:EditarPartidoBasquetbolComponent},
